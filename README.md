...
Offline-first space companion for sky events, ISRO watch, and stargazing curiosity.

- Live website: https://snakeeye-sudo.github.io/Antariksh-Sathi/
- Family hub: https://snakeeye-sudo.github.io/Aapka-Sathi/
- GitHub repo: https://github.com/SnakeEye-sudo/Antariksh-Sathi
- Tags: sathi-family, space-app, astronomy, education, pwa, hindi-app
